...
{ percentual >= 40 && percentual<60 ?(<IconMoodConfuzed size={40} stroke={1.5} className="text-yellow-500" />
): percentual >= 60 ?( <IconMoodSad size={40} stroke={1.5} className="text-red-500" />
