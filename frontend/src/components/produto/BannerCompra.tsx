...
const parcelamento= useParcelamento(produto.precoPromocional)
    ...
    <div className='flex '>
      <div className="flex flex-col border-r border-zinc-500 pr-5 w-96 ">
                <div className="line-through text-zinc-400">de  {Moeda.formatar( produto?.precoBase)
               }</div>
...
<div className="flex gap-4 items-center   ">
                <button className="flex button bg-pink-600 rounded-full p-2 hover:bg-pink-800 ml-2 md:ml-20 " onClick={() => {}}>
                    <IconShoppingCart size={20} />
                    <span>Adicionar</span>
                </button>
                <button className="flex button bg-violet-700 rounded-full p-2  hover:bg-violet-900" onClick={() => {}}>
